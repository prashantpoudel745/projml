...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(f"Applying preprocessing on taining and testing dataset")
            ...
            ]  # np-c : This is a shorthand in NumPy to concatenate arrays column-wise. It stacks the columns of the input arrays side by side. Equivalent to np.concatenate((array1, array2), axis=1).
